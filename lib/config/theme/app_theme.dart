...
class AppThemeDS {
  ...
  static ThemeData light() {
    return ThemeData.light(useMaterial3: true).copyWith(
      ...
      scaffoldBackgroundColor: ColorsDS.bodyBg,
      ...
      dividerTheme: const DividerThemeData(
        color: ColorsDS.gray300, thickness: 1, space: 0,
      ),
  ...
  static ThemeData dark() {
    return ThemeData.dark(useMaterial3: true).copyWith(
      ...
      textTheme: _textTheme(ColorsDS.gray100),
      elevatedButtonTheme: _elevatedButton(),
      outlinedButtonTheme: _outlinedButton(),
      textButtonTheme: _textButton(),
      ...
      dividerTheme: const DividerThemeData(
        color: ColorsDS.gray700, thickness: 1, space: 0,
      ),
      appBarTheme: AppBarTheme(
  ...
  static const ColorScheme _lightScheme = ColorScheme.light(
    primary:   ColorsDS.primary,   onPrimary:   ColorsDS.white,
    secondary: ColorsDS.secondary, onSecondary: ColorsDS.white,
    error:     ColorsDS.danger,    onError:     ColorsDS.white,
    surface:   ColorsDS.white,     onSurface:   ColorsDS.bodyColor,
  ...
  static const ColorScheme _darkScheme = ColorScheme.dark(
    ...
    secondary: ColorsDS.secondary, onSecondary: ColorsDS.white,
    error:     ColorsDS.danger,    onError:     ColorsDS.white,
    surface:   ColorsDS.gray800,   onSurface:   ColorsDS.gray100,
  ...
  static InputDecorationTheme _inputDecoration({bool dark = false}) =>
