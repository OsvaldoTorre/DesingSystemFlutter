...
class TypographyDS {
  ...
  static const TextStyle h1 = TextStyle(
    ...
    color: ColorsDS.dark, height: lineHeightSm,
  );
  ...
  static const TextStyle lead = TextStyle(
    ...
    color: ColorsDS.dark, height: lineHeightBase,
  );
  ...
  static const TextStyle small = TextStyle(
    ...
    color: ColorsDS.secondary, height: lineHeightBase,
  );
  ...
  static const TextStyle caption = TextStyle(
    ...
    color: ColorsDS.gray600, height: lineHeightBase,
  );
