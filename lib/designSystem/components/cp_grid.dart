...
class CpContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxWidth = fluid ? double.infinity
    ...
    return Center(
      child: ConstrainedBox(
        ...
        child: Padding(
          padding: padding ??
              const EdgeInsets.symmetric(horizontal: SpacingsDS.md),
          child: child,
        ),
      ),
    );
...
class _SizedCol extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      width: colWidth.clamp(0, parentWidth),
      child: col,
    );
  }
}
...
class CpCol extends StatelessWidget {
  ...
  int _resolveSpan(BuildContext context) =>
      BreakpointsDS.resolve<int>(
        context,
